...
# Many of the comments in this code 
        ...
        Switch("RecordData", lambda env: env.RecordType,
            {
                ...
                'bwsp': blobData, # blob containing a binary plist.  Contains size and layout of the window.
                ...
                'icvp': blobData, # blob containing a plist, giving settings for the icon view.  appears to supplant icvo.
                ...
                'lsvp': blobData, # blob containing a binary plist.  List view settings, perhaps supplanting the 'lsvo' record.
